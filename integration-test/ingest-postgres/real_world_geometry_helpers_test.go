...
var (
	...
	firstNaturalEarthFeatureWithRole         = ingesttest.FirstFeatureWithRole
...
func makeNaturalEarthGeometryTypesRecord(t *testing.T, rowPrefix, role string, features []naturalEarthFeature) (arrow.RecordBatch, *arrow.Schema) {
	t.Helper()
