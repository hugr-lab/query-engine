...
CREATE TABLE events (
    ...
    geom_point_native GEOMETRY(Point, 0),
    geom_point_native_4326 GEOMETRY(Point, 4326),
    geom_line_wkt GEOMETRY(LineString, 0),
    geom_line_wkt_4326 GEOMETRY(LineString, 4326),
    geom_polygon_geojson GEOMETRY(Polygon, 0),
    geom_polygon_hugr_geojson GEOMETRY(Polygon, 0),
    geom_polygon_plain_geojson GEOMETRY(Polygon, 0),
    geom_polygon_geojson_struct GEOMETRY(Polygon, 0),
    geom_point_wkb GEOMETRY(Point, 0),
    geom_point_hexwkb GEOMETRY(Point, 0),
    geom_line_native GEOMETRY(LineString, 0),
    geom_line_wkb GEOMETRY(LineString, 0),
    geom_polygon_native GEOMETRY(Polygon, 0),
    geom_polygon_wkb GEOMETRY(Polygon, 0),
    geom_multipoint_native GEOMETRY(MultiPoint, 0),
    geom_multipoint_wkb GEOMETRY(MultiPoint, 0),
    geom_multiline_native GEOMETRY(MultiLineString, 0),
    geom_multiline_wkb GEOMETRY(MultiLineString, 0),
    geom_multipolygon_native GEOMETRY(MultiPolygon, 0),
    geom_multipolygon_wkb GEOMETRY(MultiPolygon, 0)
);
