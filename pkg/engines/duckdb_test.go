...
func Test_duckdb_SQLValue(t *testing.T) {
	...
	tests := []struct {
		...
		{"float value", 123.45, "123.450000000000003", false},
		...
		{"float array value", []float64{123.45, 3.14}, "ARRAY[123.450000000000003,3.140000000000000]", false},
		...
		{"time array value", []time.Time{tm, tm}, fmt.Sprintf("ARRAY['%s'::TIMESTAMPTZ,'%[1]s'::TIMESTAMPTZ]", tstr), false},
