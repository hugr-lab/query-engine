...
// DuckDB uses "main" and PostgreSQL uses "public" as their default schemas.
// See also: pkg/data-sources/sources/ducklake/introspect.go (DuckLake-specific, only "main").
