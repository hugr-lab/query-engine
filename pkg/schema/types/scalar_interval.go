...
func (s *intervalScalar) FilterSDL() string {
	return `input IntervalFilter @system {
  eq: Interval
  gt: Interval
  gte: Interval
  lt: Interval
...
func (s *intervalScalar) ListFilterSDL() string {
	return `input IntervalListFilter @system {
  eq: [Interval!]
  contains: [Interval!]
  intersects: [Interval!]
  is_null: Boolean
