...
var (
	ErrInvalidHugrQueryParam = errors.New("invalid hugr query parameter")
...
func (o *options) funcs(ctx context.Context) []gojq.CompilerOption {
	ff := timeFuncs()
	ff = append(ff, authInfo(ctx))
	if o.qe != nil {
		ff = append(ff, o.queryHugrFunc(ctx))
	}
	return ff
}
...
func authInfo(ctx context.Context) gojq.CompilerOption {
	return gojq.WithFunction("authInfo", 0, 0, func(arg any, args []any) any {
