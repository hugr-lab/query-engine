...
func Test_directiveResolver(t *testing.T) {
	...
	result, err := directiveResolver(t.Context(), static.NewWithSchema(schema), directiveDef, selectionSet, 10)
	if err != nil {
...
func Test_inputValueResolver(t *testing.T) {
	...
	result, err := inputValueResolver(t.Context(), static.NewWithSchema(schema), fieldDef, selectionSet, 10)
	if err != nil {
...
func Test_argumentResolver(t *testing.T) {
	...
	result, err := argumentResolver(t.Context(), static.NewWithSchema(schema), argDef, selectionSet, 10)
	if err != nil {
...
func Test_typeResolver(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := typeResolver(t.Context(), static.NewWithSchema(schema), tt.typeDef, tt.selectionSet, 10)
